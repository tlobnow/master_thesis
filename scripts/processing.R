...
source(file = "~/Documents/Github/mscTayLab/scripts/functions/slurmExtract.R")
source(file = "~/Documents/Github/mscTayLab/scripts/functions/jsonExtract_1.1_ratio.R")
...
### DEFINE PATHS
MAIN    = ifelse(exists("/Volumes/TAYLOR-LAB/Finn/RESULTS/"), 
                 yes =  "/Volumes/TAYLOR-LAB/Finn/RESULTS/",
                 no  =  "~/Documents/Github/transferGit/")
FOLDER  = "IP_MS"
CSV_LOC = "~/Documents/Github/mscTayLab/csv/"
TXT_LOC = "~/Documents/Github/mscTayLab/txt/"
...
if (JSON_XTRCT == T) {
  ...
  for (FILE in LIST) {
    for (i in 1:5) {
      ...
      OUT   = paste0(CSV_LOC, FOLDER)
      xtractJSON_1.1_ratio(JSON = JSON, OUT = OUT)
    } 
  }
}
